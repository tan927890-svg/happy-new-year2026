...
const WISH_MESSAGES = [
	...
	"Xuân mới nhẹ nhàng gõ cửa",
    " Mang yêu thương thắp sáng mọi nhà.",
    "Gió xuân hong ước mơ xa",
    "Nắng mai rực rỡ chan hòa niềm tin. ✨",

	 "Chúc cho sức khỏe an bình",
     "Gia đình hạnh phúc, nghĩa tình đầy vơi.",
     "Công danh rộng mở thảnh thơi",
     "Tài lộc gõ cửa, rạng ngời tương lai. ❤️",

	"Muộn phiền xin gửi lại ngày",
    "Niềm vui giữ mãi, tháng năm an lành.😊",
    "Năm mới khởi sắc tươi xanh🎉",
    "Vạn điều như ý, trọn thành ước mong. 🚀",
